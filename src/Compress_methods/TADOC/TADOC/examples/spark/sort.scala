...
val outputFile = "hdfs://ec2-35-162-58-53.us-west-2.compute.amazonaws.com:9000/sortSeq"
      val conf = new SparkConf().setAppName("sortSeq")
	...
	val pipeRDD2 = pipeRDD.join(dictionary).map{ case (t,(w,u)) => (t,u,w)}.sortBy(_._2)
